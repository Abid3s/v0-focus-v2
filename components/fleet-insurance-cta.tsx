...
export default function FleetInsuranceCTA() {
  const benefits = [
    "Competitive fleet insurance rates",
    "Expert commercial insurance advice", 
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <h2 className="text-4xl sm:text-5xl font-bold leading-tight">
                <span className="block">Get Your Fleet</span>
                <span className="block">Insurance</span>
                <span className="block text-[#F61F41]">Quote Today</span>
              </h2>

              <p className="text-xl text-blue-100 leading-relaxed">
                Protect your commercial fleet with comprehensive insurance coverage. 
            ...
            <div className="flex flex-col sm:flex-row gap-6 text-sm text-blue-200">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span>fleet@focusinsurance.co.uk</span>
              </div>
            </div>
          </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-lg mb-2">Speak to Our Fleet Experts</h3>
                    <p className="text-blue-100 mb-4">
                      Get personalised advice and competitive quotes from our commercial insurance specialists.
                    </p>
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 text-white">
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-lg mb-2">Email Your Requirements</h3>
                    <p className="text-blue-100 mb-4">
                      Send us your fleet details and we'll provide a comprehensive quote within 24 hours.
                    </p>
                    <Button className="bg-white text-[#001d3d] hover:bg-blue-50 font-semibold px-6 py-2 rounded-lg transition-all duration-300">
                      Email Us
                    </Button>
        ...
        <div className="mt-12 pt-8 border-t border-white/20">
          <p className="text-xs text-blue-200 text-center max-w-4xl mx-auto">
            *Subject to underwriting criteria, terms and conditions. All fleet insurance policies are subject to insurer acceptance. 
